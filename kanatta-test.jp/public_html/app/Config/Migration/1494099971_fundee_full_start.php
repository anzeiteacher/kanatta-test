<?php
class FundeeFullStart extends CakeMigration {
 ...
 */
	public $migration = array(
		...
		'down' => array(
			'drop_table' => array(
				'areas', 'attachments', 'backed_projects', 'backing_levels', 'banks', 'categories', 'comments', 'favourite_projects', 'mail_auths', 'message_pairs', 'messages', 'news', 'project_content_orders', 'project_contents', 'projects', 'report_content_orders', 'report_contents', 'reports', 'sessions', 'settings', 'users'
			),
		),
	);
