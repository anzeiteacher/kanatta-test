...
class Setting extends AppModel
{
    ...
    public $actsAs = array(
        'Filebinder.Bindable' => array(
            'dbStorage' => false, 'afterAttach' => 'resize',
        )
    );
        ...
        if (empty($settings)) {
            $setting = array(
                'Setting' => array(
                    ...
                    'site_name' => 'Fundee',
                    'site_title' => 'Fundee - クラウドファンディング',
                    'site_description' => 'クラウドファンディング',
                    ...
                    'company_address' => '東京都',
                    'copy_right' => '株式会社サンプル',
                    'from_mail_address' => 'system@logicky.com',
                    'admin_mail_address' => 'system@logicky.com',
                    'mail_signature' => 'クラウドファンディング',
