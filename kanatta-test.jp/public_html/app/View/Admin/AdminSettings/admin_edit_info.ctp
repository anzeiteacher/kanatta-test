...
<div class="container">
    ...
    <div class="col-md-6">
        ...
        <h4>サイト情報</h4>
        <div class="form-group">
            <?php echo $this->Form->input('site_url', array('label' => 'サイトURL')) ?>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <?php echo $this->Form->input('gmo_id', array(
                'type' => 'text', 'label' => 'GMOペイメント ショップID'
            )) ?>
        </div>
        <div class="form-group">
            <?php echo $this->Form->input('gmo_password', array('label' => 'GMOペイメント ショップパスワード')) ?>
        </div>
        <div class="form-group">
            <?php echo $this->Form->input('gmo_site_id', array(
                'type' => 'text', 'label' => 'GMOペイメント サイトID'
            )) ?>
        </div>
        <div class="form-group">
            <?php echo $this->Form->input('gmo_site_pass', array('label' => 'GMOペイメント サイトパスワード')) ?>
        </div>
        ...
        <div class="form-group">
            <?php echo $this->Form->input('facebook_api_secret', array('label' => 'Facebook API Secret')) ?>
        </div>
        <div class="form-group">
