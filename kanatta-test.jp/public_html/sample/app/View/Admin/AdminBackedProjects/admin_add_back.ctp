...
<div class="setting_title">
    <h2>『<?php echo h($pj['project_name']) ?>』の支援を手動追加</h2>
</div>
...
<div class="container">
    ...
    登録されている支援パターンの確認は
    <?php echo $this->Html->link('こちら',
        '/admin/admin_projects/edit_level/'.h($pj['id']), array('target' => '_blank'))?>。
    </p>
    <br>
    <div class="col-md-6">
        <?php echo $this->Form->create('BackedProject', array('id' => 'form1', 'inputDefaults' => array('class' => 'form-control')))?>
        <div class="form-group">
            <?php echo $this->Form->input('backing_level_id', array('type' => 'select', 'options' => $levels, 'label' => '支援パターン'))?>
        </div>
        <div class="form-group">
