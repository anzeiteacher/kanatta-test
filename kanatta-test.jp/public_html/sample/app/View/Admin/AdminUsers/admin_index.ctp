...
<div class="container">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo $this->Html->url('/admin/admin_users')?>">ユーザー一覧</a></li>
        <li><a href="<?php echo $this->Html->url('/admin/admin_users/setting') ?>">ユーザの表示項目の設定</a></li>
    </ul>
    <br><br>
    <div class="row">
        <div class="col-md-6">
